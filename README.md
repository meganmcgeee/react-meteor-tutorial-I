...
This it the code for 2 parts of  of a 10 part series of tutorials and the magic that is Meteor.JS with the awesome that is React.JS.
These tutorials are intended for a beginner audience.
...
Meteor sets you up with the bare minimum, the 3 files( an HTML file, a CSS file and a Javascript file) that it needs to function (so nice of you, Meteor!).
...
Navigate to localhost:3000 in your web browser and you should see this!
 You have created a Meteor app (even if it is boring)
...
When we use Bootstrap 3 with React.js, we use “className” instead of class because “class” is a reserved word in React. Our code in its final form for a React.JS component styled with a Bootstrap 3 jumbotron would look like this:
...
The end. Stay tuned for next week's
...
If you completed Meteor and React I: Create A Basic Component, you should be ready to begin this exercise. If not, you can find the code in the repositorory.
...
to hold our components that will be part of the layout.. We can place this folder in the components folder in clients directory that we already created.
...
and you'll have your first React Layout built. :-)
